...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    // Initialize RestKit
    //http://regisscis.net/Regis2/webresources/regis2.course
    ...
    [articleListMapping addAttributeMappingsFromDictionary:@{ @"title" : @"title", @"syndication_url" : @"url", @"description" : @"article_description" }];
    ...
    [articleListMapping addPropertyMapping:[RKRelationshipMapping relationshipMappingFromKeyPath:@"articles" toKeyPath:@"articles" withMapping:articleMapping]];
